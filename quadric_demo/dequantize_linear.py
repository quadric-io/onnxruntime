...
output_tensor = helper.make_tensor_value_info('output', TensorProto.INT32, [5])
...
def dequantize_linear_fixed_point(x, s, zp):
...
print('Output (converted to float):', output[0]/(2**27))
