            ...
            graph=make_graph(
                ...
                initializer=[
                    ...
                    numpy_helper.from_array(
                        np.array(0.007874015718698502, dtype="float32"), name="shape_checkpont_1_wt_scale"
                    ),
                    numpy_helper.from_array(np.array(0, dtype="int8"), name="shape_checkpont_1_wt_zero_point"),
                    numpy_helper.from_array(
                        np.ones([1, 16, 7, 7]).astype("int8"), name="shape_checkpont_1_wt_quantized"
                    ),
                ...
                nodes=[
                    make_node(
                        "QuantizeLinear",
                        inputs=["input.1", "input.1_scale", "input.1_zero_point"],
                        outputs=["input.1_quantized"],
                        name="input.1_QuantizeLinear",
                    ),
                    make_node(
                        "QLinearAdd",
                        inputs=[
                    ...
                    make_node(
                        "QGemm",
                        inputs=[
                            "flatten_out_quantized",
                            "gap_out_scale",
                            "gap_out_zero_point",
                            "dense_wt_quantized",
                            "dense_wt_scale",
                            "dense_wt_zero_point",
                            "dense_bias_quantized",
                            "dense_out_scale",
                            "dense_out_zero_point",
                        ],
                    ...
                    make_node(
                        "DequantizeLinear",
                        inputs=["dense_out_quantized", "dense_out_scale", "dense_out_zero_point"],
                        outputs=["dense_out"],
                        name="dense_out_DequantizeLinear",
                    ),
                ],
            ),
        )
